...
from handlers.messages.games.guessing.actions import win, not_win
...
@dp.message_handler(state=GuessingState.num_4)
async def num_4(message: Message, state: FSMContext):
