...
from handlers.messages.profile.games.guessing.actions import win, not_win, losses
...
@dp.message_handler(state=GuessingState.num_7)
async def num_7(message: Message, state: FSMContext):
