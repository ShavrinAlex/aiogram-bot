...
from handlers.messages.profile.games.guessing.actions import losses, win, not_win
...
@dp.message_handler(state=GuessingState.num_8)
async def num_8(message: Message, state: FSMContext):
